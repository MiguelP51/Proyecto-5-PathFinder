...
const areas: AreaItem[] = [
  {
    ...
    functions: [
      ...
      },
      {
        ...
        description: "Diseña programas de formación y crecimiento profesional.",
      },
      {
      ...
      },
      {
        ...
        description: "Promueve un entorno laboral saludable y motivador.",
      },
    ],
  },
  {
  ...
  return (
    <main className={styles.areasPage}>
      ...
      {areas.map((area, index) => (
        <AreaDetail key={area.title} area={area} reverse={index % 2 !== 0} />
      ))}
    </main>
  );
}
