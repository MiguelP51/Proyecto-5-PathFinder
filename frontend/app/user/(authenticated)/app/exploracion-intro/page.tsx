...
export default function ExploracionIntroPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-linear-to-br from-[#eef3fb] via-white to-[#f0eeff] px-4 py-10 text-[#081333]">
      {/* ── Dots de navegación ── */}
      ...
      <div className="w-full max-w-3xl rounded-2xl border border-slate-200 bg-white p-8 shadow-md md:p-10">
        <div className="flex flex-col gap-8 md:flex-row md:items-center">
          ...
          <div
            className={`flex h-52 w-full shrink-0 items-center justify-center rounded-2xl bg-linear-to-br ${slide.illustrationBg} md:h-60 md:w-60`}
          >
            <Icon
      ...
      <p className="mt-4 text-center text-xs text-slate-400">
        Puedes volver a ver este tutorial en cualquier momento desde el ícono de
        ayuda (?) en el header
      </p>
    </div>
  );
