...
export default function PathChallengesPage() {
  ...
  const misiones = [
    {
      id: 1,
      titulo: "Rediseño de Dashboard Analítico",
      tags: ["Wireframing", "Prototipado", "+1"],
    ...
    },
    {
      ...
      tags: ["Node.js", "Express", "+2"],
      subarea: "Backend Development",
      dificultad: "Dificil",
      tareas: 4,
      xp: 250,
      completadas: 23,
  ...
  return (
    <div className="min-h-screen bg-slate-50/30 p-6 md:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <section className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200/60 pb-6">
        ...
        <button className="flex items-center gap-2 self-start rounded-xl bg-pink-600 hover:bg-pink-700 text-white px-5 py-2.5 shadow-md shadow-pink-200 transition text-sm font-bold">
      ...
      <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <article className="rounded-3xl border border-slate-200/70 bg-white p-5 shadow-sm flex items-center gap-4">
          ...
          <div>
            <span className="text-2xl font-black text-slate-800">43</span>
        ...
        <article className="rounded-3xl border border-slate-200/70 bg-white p-5 shadow-sm flex items-center gap-4">
          ...
          <div>
            <span className="text-2xl font-black text-slate-800">1,892</span>
        ...
        <article className="rounded-3xl border border-slate-200/70 bg-white p-5 shadow-sm flex items-center gap-4">
          ...
          <div>
            <span className="text-2xl font-black text-slate-800">284,800</span>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left text-sm text-slate-700">
            ...
            <tbody className="divide-y divide-slate-100 font-medium">
              {misiones.map((mision) => (
                <tr key={mision.id} className="hover:bg-slate-50/40 transition">
                  ...
                  <td className="px-6 py-4 text-slate-500 text-xs">{mision.subarea}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-slate-500 text-xs text-center">{mision.tareas}</td>
                  <td className="px-6 py-4">
