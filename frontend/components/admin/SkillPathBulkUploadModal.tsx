          ...
          {!result ? (
            <>
              <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center bg-slate-50/50">
                ...
                <p className="text-xs text-slate-500 mb-4">El archivo debe contener cabeceras: titulo, plataforma, subareaNombre, dificultad, duracionLabel, urlExterno, descripcion.</p>
