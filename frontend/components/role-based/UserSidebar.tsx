...
export default function UserSidebar({ open, onClose }: Props) {
  ...
  const isEnrollmentCompleted = statusData?.etapas?.EVALUACION_ENTREVISTA === "COMPLETADA";
              ...
              <div className="space-y-1.5 pl-2 border-l border-slate-100 dark:border-slate-800 ml-3">
                {(() => {
                  const miEspacioLinks = [
                    ...
                    { href: "/user/app/exploracion/dashboard", label: "Dashboard", icon: <LayoutDashboard className="h-5 w-5" />, isLocked: !isEnrollmentCompleted },
                    { href: "/user/explore", label: "Explorar", icon: <Compass className="h-5 w-5" />, isLocked: !isEnrollmentCompleted },
                    { href: "/user/app/skillpaths", label: "SkillPaths", icon: <BookOpen className="h-5 w-5" />, isLocked: !isEnrollmentCompleted },
                    { href: "/user/app/challenges", label: "Challenges", icon: <Trophy className="h-5 w-5" />, isLocked: !isEnrollmentCompleted },
                    { 
